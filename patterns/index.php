...
/**
 * Title: index
 * Slug: starter-block-theme/index
 * Inserter: no
 */
?>
...
<div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:heading {"level":1,"style":{"elements":{"link":{"color":{"text":"var:preset|color|margenta"}}}},"textColor":"margenta"} -->
<h1 class="wp-block-heading has-margenta-color has-text-color has-link-color"><?php /* Translators: 1. is the start of a 'strong' HTML element, 2. is the end of a 'strong' HTML element */ 
echo sprintf( esc_html__( '%1$sBlog%2$s', 'starter-block-theme' ), '<strong>', '</strong>' ); ?></h1>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<!-- wp:post-title {"textAlign":"left","style":{"typography":{"fontSize":"20px","fontStyle":"normal","fontWeight":"700"},"elements":{"link":{"color":{"text":"var:preset|color|contrast"}}}},"textColor":"contrast"} /-->
